  ...
  const handleSendMessage = async () => {
    ...
    if (currentLimit <= 0) {
      const errorMessage: ChatMessage = {
        id: crypto.randomUUID(),
        role: 'assistant',
        content: 'You have reached your message limit. Please contact an administrator to increase your limit.',
        timestamp: new Date()
      };
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-b-2xl">
            ...
            <div className="flex gap-2">
              <input
                ...
                disabled={(profile?.message_limit !== undefined ? profile.message_limit : 100) <= 0}
              ...
              <button
                ...
                disabled={!inputMessage.trim() || isLoading || (profile?.message_limit !== undefined ? profile.message_limit : 100) <= 0}
