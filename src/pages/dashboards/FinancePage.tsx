...
import { DollarSign, TrendingUp, TrendingDown, Plus, Search, X, Edit2, Trash2 } from 'lucide-react';
...
export function FinancePage() {
  ...
  const handleSave = async () => {
    if (!formData.category || !formData.amount || !formData.transaction_date) return;
  ...
  const totalIncome = filteredByYear.filter(r => r.transaction_type === 'income').reduce((sum, r) => sum + Number(r.amount), 0);
  const totalExpense = filteredByYear.filter(r => r.transaction_type === 'expense').reduce((sum, r) => sum + Number(r.amount), 0);
  ...
  const incomeRecords = filteredByYear.filter(r => r.transaction_type === 'income');
  const expenseRecords = filteredByYear.filter(r => r.transaction_type === 'expense');
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            ...
            className="bg-green-500 rounded-xl p-6 text-white cursor-pointer hover:bg-green-600 transition-colors"
          >
          ...
          <div
            ...
            className="bg-red-500 rounded-xl p-6 text-white cursor-pointer hover:bg-red-600 transition-colors"
          >
            <div className="flex items-center justify-between mb-4">
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={7} className="px-6 py-4 text-center text-gray-500 dark:text-gray-400">No transactions found</td>
                  </tr>
                ) : (
                  filteredRecords.map((record) => (
                    <tr key={record.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">{record.category}</td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-300">{record.payment_method}</td>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Income Analysis</h2>
                <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie data={incomeByCategoryData} cx="50%" cy="50%" outerRadius={100} dataKey="value" label>
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {incomeRecords.map((record) => (
                        <tr key={record.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                          ...
                          <td className="px-4 py-2 text-sm text-gray-900 dark:text-gray-300">{record.category}</td>
                          <td className="px-4 py-2 text-sm text-gray-900 dark:text-gray-300">{record.description}</td>
      ...
      {showExpenseModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Expense Analysis</h2>
                <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Expense by Category</h3>
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie data={expenseByCategoryData} cx="50%" cy="50%" outerRadius={100} dataKey="value" label>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Expense Records</h3>
                <div className="overflow-x-auto max-h-96">
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-gray-900 sticky top-0">
                      <tr>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full">
            <div className="p-6">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  onClick={handleSave}
                  disabled={saving || !formData.category || !formData.amount || !formData.transaction_date}
