...
export function AssignmentsPage() {
  ...
  return (
    <DashboardLayout>
      {/* Wrapper fixed for mobile: no horizontal scroll, desktop unchanged */}
      <div className="space-y-6 w-full min-w-0 px-4 sm:px-6 md:px-8 overflow-x-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 md:items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <select
              ...
              className="px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white min-w-[160px]"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 min-w-0">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 border-l-4 border-blue-500 shadow-sm">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 border-l-4 border-green-500 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">
                Avg Completion
              </span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 border-l-4 border-orange-500 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">
                On-Time Rate
              </span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 border-l-4 border-purple-500 shadow-sm">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600 dark:text-gray-400">
                Avg Score
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 min-w-0">
          {/* Left chart */}
          <div className="lg:col-span-2 min-w-0 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b-2 border-gray-200 dark:border-gray-700">
                    ...
                    <th className="text-left py-3 px-3 sm:px-4 font-semibold text-gray-700 dark:text-gray-300">
                      <div className="flex items-center gap-1">Submission</div>
                    </th>
                    <th className="text-left py-3 px-3 sm:px-4 font-semibold text-gray-700 dark:text-gray-300">
                      <div className="flex items-center gap-1">
                        Status
